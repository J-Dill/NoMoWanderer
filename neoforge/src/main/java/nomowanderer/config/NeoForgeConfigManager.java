...
/**
 * NeoForge implementation of ConfigManager.
 * Handles TOML config file generation and persistence for NeoForge.
 */
public class NeoForgeConfigManager implements ConfigManager {
    private final Map<String, ConfigSpec> configs = new HashMap<>();
    private final Path configDir;

    public NeoForgeConfigManager() {
